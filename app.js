...
const baseItems = [
  {
    ...
    high: 12000,
    profit: 1.15,
    note: "PRO360 2026 參考：設計費約 4,500-12,000 元/坪，圖面深度與 3D 圖另議",
  },
  {
    category: "設計",
    name: "設計監造 / 工程管理費",
    ...
    high: 150000,
    profit: 1.1,
    note: "PRO360 2026 參考：監工費常以總工程款 5% 到 15% 估算",
  },
  {
    category: "拆除",
    name: "舊裝潢拆除與基本清運",
  ...
  },
  {
    ...
    high: 40000,
    profit: 1.25,
    note: "PRO360 2026 浴室整修參考 15-25 萬元/間，防水單項約 6,000-10,000 元/間；老屋需先檢查管線、門檻、洩水坡度",
  },
  {
    category: "水電",
    name: "全室水電重拉：2 房住宅基準",
  ...
  },
  {
    ...
    high: 8500,
    profit: 1.2,
    note: "健康建築 / GD 2026 參考：平釘天花板約 4,500-5,500 元/坪、造型天花板約 6,000-8,500 元/坪；燈槽、圓弧、檢修孔、冷氣包管另列",
  },
  {
    category: "系統櫃",
    name: "系統高櫃：門片式",
  ...
  },
  {
    ...
    high: 2500,
    profit: 1.2,
    note: "健康建築 / GD 2026 參考：基礎油漆約 1,600-2,500 元/坪；特殊漆、跳色、修補面積大需另計",
  },
  {
    category: "地板",
    name: "SPC / 超耐磨木地板鋪設",
    ...
    high: 7500,
    profit: 1.18,
    note: "健康建築 / GD 2026 參考：SPC 約 3,000-5,500 元/坪，超耐磨木地板約 4,000-7,500 元/坪；品牌厚度另調",
  },
  {
    category: "廚具",
  ...
  },
  {
    ...
    high: 100000,
    profit: 1.18,
    note: "PRO360 2026 衛浴設備安裝分項參考：洗臉盆 4,000-20,000、馬桶 8,000-15,000、龍頭 1,500-4,000 元；品牌、壁掛或免治設備另計",
  },
  {
    category: "燈具",
    name: "基本吸頂燈 / 崁燈 / 線燈配置",
...
const cityMarketRates = {
  taichung: {
    name: "台中市",
    updated: "115 年 Q3 / 2026-07-16",
    source: "臺中市不動產建築開發商業同業公會 115 年第三季工程市場行情表，並補充 2026 台灣居住裝修行情與台中住宅裝修坪單價公開參考。",
    ...
    items: [
      ...
      },
      {
        ...
        low: 25000,
        high: 28000,
        note: "115 年 Q3 官方表：由 Q2 的 23,000-26,000 元/建坪調升；材料與做法不同差價很大",
      },
      {
        category: "弱電",
        name: "弱電工程",
      ...
      },
      {
        ...
        low: 280,
        high: 310,
        note: "公共空間地坪，115 年 Q3 官方表沿用 Q2 的 280-310 元/㎡",
      },
      {
        category: "泥作",
        name: "內牆 1:3 打底工資",
        ...
        low: 350,
        high: 385,
        note: "115 年 Q3 官方表沿用 Q2 的 350-385 元/㎡",
      },
      {
        category: "泥作",
        name: "內牆 1:3 水泥粉光工資",
      ...
      },
      {
        ...
        low: 480,
        high: 550,
        note: "115 年 Q3 官方表沿用 Q2 的 480-550 元/㎡；特殊磚、拼法與基底另計",
      },
      {
        category: "泥作",
      ...
      },
      {
        ...
        low: 580,
        high: 750,
        note: "含吊料、硬底，115 年 Q3 官方表沿用 Q2 的 580-750 元/㎡",
      },
      {
        category: "防水",
        name: "地坪 / 牆面防水：聚脲噴塗",
        ...
        low: 1100,
        high: 1400,
        note: "115 年 Q1 區間，慶泰參考；品牌與厚度需確認",
      },
      {
        category: "清運",
        name: "工地營建廢棄物載運",
        ...
        low: 2500,
        high: 2800,
        note: "115 年 Q3 官方表沿用 Q2 的 2,500-2,800 元/M3；混凝土塊、磁磚等",
      },
      {
        category: "清運",
        name: "工地廢棄物載運",
        ...
        low: 850,
        high: 850,
        note: "115 年 Q3 官方表沿用 Q2 的 850 元/建坪",
      },
      {
        category: "結構材料",
        name: "竹節鋼筋 SD280",
        ...
        low: 17600,
        high: 17600,
        note: "115 年 Q3 官方表：由 Q2 每噸 18,900 元下修至 17,600 元",
      },
      {
        category: "結構材料",
        name: "竹節鋼筋 SD420W",
        ...
        low: 18800,
        high: 18800,
        note: "115 年 Q3 官方表：由 Q2 每噸 20,100 元下修至 18,800 元",
      },
      {
        category: "矽利康",
        name: "室內矽利康",
      ...
      },
      {
        ...
        low: 1400,
        high: 1500,
        note: "115 年 Q3 官方表：19+75+19 石膏板雙面單層加隔音棉，由 Q2 的 1,480-1,580 元/㎡下修",
      },
      {
        category: "天花",
