...
const baseItems = [
  ...
  },
  {
    ...
    high: 40000,
    profit: 1.25,
    note: "Barsyn 2026-03 浴室防水參考 15,000-40,000 元/間；老屋需先檢查管線、門檻、洩水坡度",
  },
  {
    category: "水電",
    name: "全室水電重拉：2 房住宅基準",
  ...
  },
  {
    ...
    high: 8000,
    profit: 1.2,
    note: "Barsyn 2026 Q2 天花板參考 3,000-8,000 元/坪；燈槽、圓弧、檢修孔、冷氣包管另列",
  },
  {
    category: "系統櫃",
    name: "系統高櫃：門片式",
  ...
  },
  {
    ...
    high: 2500,
    profit: 1.2,
    note: "Barsyn 2026 Q2 油漆工程參考 1,600-2,500 元/坪；特殊漆、跳色、修補面積大需另計",
  },
  {
    category: "地板",
    name: "SPC / 超耐磨木地板鋪設",
    ...
    high: 8000,
    profit: 1.18,
    note: "Barsyn 2026 Q2 超耐磨木地板參考 4,000-8,000 元/坪；SPC 依品牌厚度另調",
  },
  {
    category: "廚具",
  ...
  },
  {
    ...
    high: 100000,
    profit: 1.18,
    note: "Barsyn 2026-03 衛浴設備參考 20,000-100,000 元/套；品牌、壁掛或免治設備另計",
  },
  {
    category: "燈具",
    name: "基本吸頂燈 / 崁燈 / 線燈配置",
...
const cityMarketRates = {
  taichung: {
    name: "台中市",
    updated: "115 年 Q1 官方表 / 2026-04-20 Q2 補充",
    source: "臺中市不動產建築開發商業同業公會 115 年第一季工程市場行情表，並補充富比士地產王 2026-04-20 引用 115 年第二季行情變動、2026 Q2 台灣居住裝修行情與台中住宅裝修坪單價公開參考。",
    ...
    items: [
      ...
      },
      {
        ...
        low: 350,
        high: 385,
        note: "115 年 Q2 報導：內外牆打底工資上限較前季約下修 25 元",
      },
      {
        category: "泥作",
        name: "內牆 1:3 水泥粉光工資",
        ...
        low: 350,
        high: 385,
        note: "115 年 Q2 報導：水泥粉光工資上限較前季約下修 25 元",
      },
      {
        category: "泥作",
        name: "內牆貼 30x60 磁磚",
      ...
      },
      {
        ...
        low: 2500,
        high: 2800,
        note: "115 年 Q1 區間；混凝土塊、磁磚等，較 2025 Q4 上調",
      },
      {
        category: "清運",
        name: "工地廢棄物載運",
        ...
        low: 850,
        high: 850,
        note: "富比士地產王 2026-04-20 引用 115 年 Q2 行情：由每建坪 720 元調升至 850 元",
      },
      {
        category: "結構材料",
        name: "竹節鋼筋 SD280",
        ...
        low: 18900,
        high: 18900,
        note: "富比士地產王 2026-04-20 引用 115 年 Q2 行情：由 Q1 每噸 16,400 元調升至 18,900 元",
      },
      {
        category: "結構材料",
        name: "竹節鋼筋 SD420W",
        ...
        low: 20100,
        high: 20100,
        note: "富比士地產王 2026-04-20 引用 115 年 Q2 行情：由 Q1 每噸 17,600 元調升至 20,100 元",
      },
      {
        category: "矽利康",
        name: "室內矽利康",
